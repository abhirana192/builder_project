...
const PrintActivityDetails: React.FC<PrintActivityDetailsProps> = ({
  activities,
  children,
}) => {
    ...
    <Dialog>
      ...
      <DialogContent className="max-w-4xl max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          ...
          <DialogDescription>
            Overview for guides and staff. Includes timing, capacity, and
            signatures.
          </DialogDescription>
        </DialogHeader>
                ...
                <CardContent className="space-y-3">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-3 text-sm">
                    <div className="flex items-center gap-2">
                      ...
                      <span>
                        {fmtDateTime(a.scheduled_date, a.scheduled_time)}
                      </span>
                    </div>
                    <div className="flex items-center gap-2">
                      <User className="h-4 w-4 text-muted-foreground" />
                      <span className="font-medium">Guide:</span>
                      <span>{a.guide_name || "N/A"}</span>
                    </div>
                    <div className="flex items-center gap-2">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <span>
                        {a.attendance_count} / {a.max_participants}
                      </span>
                    </div>
                    {a.booking_reference && (
                      <div className="flex items-center gap-2">
                    ...
                    {a.weather_conditions && (
                      <div className="flex items-center gap-2">
                        ...
                        <span>{a.weather_conditions}</span>
                      </div>
                    )}
                  </div>
